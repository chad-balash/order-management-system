...
INSERT INTO products (item_id, product_name, department_name, price, stock_quantity)
VALUE ('URG-247L', '3 Shelf Industrial ANSI A+ First Aid Station - 100 Person', 'First Aid Cabinets', 149.42, 12);

INSERT INTO products (item_id, product_name, department_name, price, stock_quantity)
VALUE ('URG-3650', 'BBP / Bodily Fluid Protection Kit with Bonus 6 piece CPR kit', 'Bloodborne Pathogen Kits', 18.16, 52);

INSERT INTO products (item_id, product_name, department_name, price, stock_quantity)
VALUE ('URG-3651', 'Bodily Fluid Clean Up Pack / Bloodborne Pathogen Spill Kit', 'Bloodborne Pathogen Kits', 11.73, 316);

INSERT INTO products (item_id, product_name, department_name, price, stock_quantity)
VALUE ('URG-3660', 'OSHA Contractors First Aid Kit, 10 Person', 'Contractor First Aid Kits', 13.47, 181);

INSERT INTO products (item_id, product_name, department_name, price, stock_quantity)
VALUE ('URG-3661', 'OSHA Contractors First Aid Kit, Plastic, 25 Person', 'Contractor First Aid Kits', 16.06, 88);
